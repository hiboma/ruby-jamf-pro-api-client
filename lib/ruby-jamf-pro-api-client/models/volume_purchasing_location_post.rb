...
module JamfPro
  class VolumePurchasingLocationPost
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::VolumePurchasingLocationPost` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::VolumePurchasingLocationPost`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'automatically_populate_purchased_content')
        ...
        self.automatically_populate_purchased_content = false
      end
      ...
      if attributes.key?(:'send_notification_when_no_longer_assigned')
        ...
        self.send_notification_when_no_longer_assigned = false
      end
    ...
    def list_invalid_properties
      ...
      if @service_token.nil?
        invalid_properties.push('invalid value for "service_token", service_token cannot be nil.')
      end
    ...
    def valid?
      return false if @service_token.nil?
      true
    end
