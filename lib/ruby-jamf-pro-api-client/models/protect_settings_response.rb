  ...
  class ProtectSettingsResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::ProtectSettingsResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::ProtectSettingsResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'api_client_name')
        self.api_client_name = attributes[:'api_client_name']
      end
      ...
      if attributes.key?(:'protect_url')
        self.protect_url = attributes[:'protect_url']
      end
      ...
      if attributes.key?(:'auto_install')
        self.auto_install = attributes[:'auto_install']
      end
    end
    ...
    def valid?
      sync_status_validator = EnumAttributeValidator.new('String', ["IN_PROGRESS", "COMPLETED", "ERROR", "UNKNOWN"])
    ...
    def sync_status=(sync_status)
      validator = EnumAttributeValidator.new('String', ["IN_PROGRESS", "COMPLETED", "ERROR", "UNKNOWN"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          api_client_name == o.api_client_name &&
          registration_id == o.registration_id &&
          protect_url == o.protect_url &&
    ...
    def hash
      [id, api_client_id, api_client_name, registration_id, protect_url, last_sync_time, sync_status, auto_install].hash
    end
