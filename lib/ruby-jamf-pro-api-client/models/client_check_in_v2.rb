...
module JamfPro
  class ClientCheckInV2
    ...
    attr_accessor :hook_hide_restore

    attr_accessor :hook_mcx

    attr_accessor :background_hooks

    attr_accessor :hook_display_status
    ...
    def self.openapi_types
      {
        ...
        :'hook_hide_restore' => :'Boolean',
        :'hook_mcx' => :'Boolean',
        :'background_hooks' => :'Boolean',
        :'hook_display_status' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::ClientCheckInV2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::ClientCheckInV2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hook_hide_restore')
        self.hook_hide_restore = attributes[:'hook_hide_restore']
      else
        self.hook_hide_restore = false
      end

      if attributes.key?(:'hook_mcx')
        self.hook_mcx = attributes[:'hook_mcx']
      else
        self.hook_mcx = false
      end

      if attributes.key?(:'background_hooks')
        self.background_hooks = attributes[:'background_hooks']
      else
        self.background_hooks = false
      end

      if attributes.key?(:'hook_display_status')
        self.hook_display_status = attributes[:'hook_display_status']
      else
        self.hook_display_status = false
      end
      ...
      if attributes.key?(:'startup_mcx')
        self.startup_mcx = attributes[:'startup_mcx']
      else
        self.startup_mcx = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          hook_hide_restore == o.hook_hide_restore &&
          hook_mcx == o.hook_mcx &&
          background_hooks == o.background_hooks &&
          hook_display_status == o.hook_display_status &&
    ...
    def hash
      [check_in_frequency, create_hooks, hook_log, hook_policies, hook_hide_restore, hook_mcx, background_hooks, hook_display_status, create_startup_script, startup_log, startup_policies, startup_ssh, startup_mcx, enable_local_configuration_profiles].hash
    end
