...
module JamfPro
  class Purchasing
    ...
    attr_accessor :warranty_expires_date

    attr_accessor :lease_expires_date
    ...
    def self.openapi_types
      {
        ...
        :'po_date' => :'Time',
        :'warranty_expires_date' => :'Time',
        :'lease_expires_date' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::Purchasing` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::Purchasing`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'warranty_expires_date')
        self.warranty_expires_date = attributes[:'warranty_expires_date']
      end

      if attributes.key?(:'lease_expires_date')
        self.lease_expires_date = attributes[:'lease_expires_date']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          po_date == o.po_date &&
          warranty_expires_date == o.warranty_expires_date &&
          lease_expires_date == o.lease_expires_date &&
    ...
    def hash
      [is_purchased, is_leased, po_number, vendor, apple_care_id, purchase_price, purchasing_account, po_date, warranty_expires_date, lease_expires_date, life_expectancy, purchasing_contact].hash
    end
