  ...
  class CloudLdapServerUpdate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::CloudLdapServerUpdate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::CloudLdapServerUpdate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @connection_timeout < 1
        invalid_properties.push('invalid value for "connection_timeout", must be greater than or equal to 1.')
      end
      ...
      if @search_timeout < 1
        invalid_properties.push('invalid value for "search_timeout", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @connection_timeout < 1
      return false if @search_timeout.nil?
      return false if @search_timeout < 1
    ...
    def connection_timeout=(connection_timeout)
      ...
      if connection_timeout < 1
        fail ArgumentError, 'invalid value for "connection_timeout", must be greater than or equal to 1.'
      end
    ...
    def search_timeout=(search_timeout)
      ...
      if search_timeout < 1
        fail ArgumentError, 'invalid value for "search_timeout", must be greater than or equal to 1.'
      end
