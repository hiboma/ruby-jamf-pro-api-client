...
module JamfPro
  class UpdateMobileDeviceV2
    ...
    attr_accessor :updated_extension_attributes
    ...
    def self.openapi_types
      {
        ...
        :'time_zone' => :'String',
        :'location' => :'LocationV2',
        :'updated_extension_attributes' => :'Array<ExtensionAttributeV2>',
        :'ios' => :'UpdateIosV2',
        :'tvos' => :'UpdateTvOs'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::UpdateMobileDeviceV2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::UpdateMobileDeviceV2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'updated_extension_attributes')
        if (value = attributes[:'updated_extension_attributes']).is_a?(Array)
          self.updated_extension_attributes = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          location == o.location &&
          updated_extension_attributes == o.updated_extension_attributes &&
          ios == o.ios &&
          tvos == o.tvos
    end
    ...
    def hash
      [name, enforce_name, asset_tag, site_id, time_zone, location, updated_extension_attributes, ios, tvos].hash
    end
