...
module JamfPro
  ...
  class AppleTvDetails
    ...
    attr_accessor :airplay_password
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JamfPro::AppleTvDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JamfPro::AppleTvDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'airplay_password')
        self.airplay_password = attributes[:'airplay_password']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          airplay_password == o.airplay_password &&
    ...
    def hash
      [model, model_identifier, model_number, is_supervised, airplay_password, device_id, locales, purchasing, configuration_profiles].hash
    end
