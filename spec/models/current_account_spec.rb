...
# Unit tests for JamfPro::CurrentAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe JamfPro::CurrentAccount do
  let(:instance) { JamfPro::CurrentAccount.new }

  describe 'test an instance of CurrentAccount' do
    it 'should create an instance of CurrentAccount' do
      expect(instance).to be_instance_of(JamfPro::CurrentAccount)
    end
  end
