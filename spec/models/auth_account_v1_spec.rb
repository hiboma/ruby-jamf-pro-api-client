...
# Unit tests for JamfPro::AuthAccountV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe JamfPro::AuthAccountV1 do
  let(:instance) { JamfPro::AuthAccountV1.new }

  describe 'test an instance of AuthAccountV1' do
    it 'should create an instance of AuthAccountV1' do
      expect(instance).to be_instance_of(JamfPro::AuthAccountV1)
    end
  end
  ...
  describe 'test attribute "multi_site_admin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
