...
# Unit tests for JamfPro::Authorization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe JamfPro::Authorization do
  let(:instance) { JamfPro::Authorization.new }

  describe 'test an instance of Authorization' do
    it 'should create an instance of Authorization' do
      expect(instance).to be_instance_of(JamfPro::Authorization)
    end
  end
