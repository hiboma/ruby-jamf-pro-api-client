...
# Unit tests for JamfPro::SsoCertificateApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SsoCertificateApi' do
  before do
  ...
  describe 'test an instance of SsoCertificateApi' do
    it 'should create an instance of SsoCertificateApi' do
      expect(@api_instance).to be_instance_of(JamfPro::SsoCertificateApi)
    end
  end

  # unit tests for v2_sso_cert_delete
  # Delete the currently configured certificate used by SSO 
  # Deletes the currently configured certificate used by SSO.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v2_sso_cert_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_sso_cert_download_get
  ...
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'v2_sso_cert_download_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_sso_cert_get
  ...
  describe 'v2_sso_cert_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_sso_cert_parse_post
  ...
  describe 'v2_sso_cert_parse_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_sso_cert_post
  ...
  # @param [Hash] opts the optional parameters
  # @return [SsoKeystoreResponseWithDetails]
  describe 'v2_sso_cert_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_sso_cert_put
  # Update the certificate used by Jamf Pro to sign SSO requests to the identify provider 
  # Update the certificate used by Jamf Pro to sign SSO requests to the identify provider.
  # @param sso_keystore 
  # @param [Hash] opts the optional parameters
  # @return [SsoKeystoreResponseWithDetails]
  describe 'v2_sso_cert_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
