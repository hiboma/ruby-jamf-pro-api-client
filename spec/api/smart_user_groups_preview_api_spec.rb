...
# Unit tests for JamfPro::SmartUserGroupsPreviewApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SmartUserGroupsPreviewApi' do
  before do
  ...
  describe 'test an instance of SmartUserGroupsPreviewApi' do
    it 'should create an instance of SmartUserGroupsPreviewApi' do
      expect(@api_instance).to be_instance_of(JamfPro::SmartUserGroupsPreviewApi)
    end
  end

  # unit tests for v1_smart_user_groups_id_recalculate_post
  ...
  describe 'v1_smart_user_groups_id_recalculate_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_users_id_recalculate_smart_groups_post
  ...
  # @param [Hash] opts the optional parameters
  # @return [RecalculationResults]
  describe 'v1_users_id_recalculate_smart_groups_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
